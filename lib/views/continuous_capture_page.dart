  ...
  Widget build(BuildContext context) {
    ...
    return Focus(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Obx(() => Text(
                'Pohon ${controller.currentTreeNumber.value}',
              )),
          elevation: 0,
          actions: [
            IconButton(
        ...
        child: Column(
          ...
          children: [
            ...
            Obx(() {
              ...
              final cameraHeight = screenHeight * 0.6; // 60% dari tinggi layar
                  ...
                  Obx(() {
                    ...
                    return GridView.builder(
                      ...
                      itemBuilder: (_, index) {
                        ...
                        final isCurrent = index == controller.currentPhotoIndex.value;
            ...
            Obx(() {
              ...
              return Obx(() {
                ...
                return SizedBox(
                  ...
                  child: FilledButton.icon(
                    onPressed: (canCapture && !isCapturing) ? _handleCapture : null,
                    style: FilledButton.styleFrom(
                      padding: const EdgeInsets.symmetric(vertical: 14),
                      backgroundColor: (canCapture && !isCapturing) ? null : Colors.grey,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(12),
                      ),
                    ),
